...
def A1_main():
    ...
    #Remove unnecessary features using SelectKBest (k = 60)
    tr_Xsel, te_Xsel = feature_selection(tr_X2, tr_Y2, te_X2, 60)
    tr_Xpca, te_Xpca = pca(tr_Xsel, te_Xsel, 20)
